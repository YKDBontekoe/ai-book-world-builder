...
describe("ChapterActions", () => {
  ...
  it("handles successful generation flow", async () => {
    ...
    vi.mocked(storyGenerationActions.planChapterScenes).mockImplementation(async () => {
    ...
    vi.mocked(storyGenerationActions.generateSceneText).mockImplementation(async () => {
        await new Promise(resolve => setTimeout(resolve, 300));
        return {
            success: true,
            data: { success: true },
    ...
    expect(storyGenerationActions.generateSceneText).toHaveBeenCalledWith("scene-1");
    expect(storyGenerationActions.generateSceneText).toHaveBeenCalledWith("scene-2");
