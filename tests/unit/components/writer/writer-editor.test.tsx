...
import type * as writerContext from "@/components/organisms/writer/writer-context";
...
vi.mock(
	"@/components/organisms/writer/writer-context",
...
vi.mock(
	"@/components/organisms/writer/writer-layout-context",
	async (importOriginal) => {
