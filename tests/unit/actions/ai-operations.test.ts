...
describe('AI Operations Actions', () => {
  ...
  describe('batchWriteChapterAction', () => {
    it('should return success response on success', async () => {
      vi.mocked(writingService.batchWriteChapter).mockResolvedValue({ success: true, writtenCount: 5 } as any);
  ...
  describe('rewriteSceneAction', () => {
    it('should return result on success', async () => {
      vi.mocked(writingService.rewriteScene).mockResolvedValue({ text: 'rewritten' } as any);
  ...
  describe('critiqueChapterAction', () => {
    it('should return data on success', async () => {
      vi.mocked(analysisService.critiqueChapter).mockResolvedValue({ critique: 'good' } as any);
