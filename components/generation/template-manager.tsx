		...
		<div className="space-y-4">
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-2">
					...
					<h3 className="text-sm font-medium">Generation Templates</h3>
				</div>
				<Dialog open={showSaveDialog} onOpenChange={setShowSaveDialog}>
					...
					<DialogContent>
						<DialogHeader>
							...
							<DialogDescription>
								Save your current generation settings as a reusable template.
							</DialogDescription>
						</DialogHeader>
				...
				<div className="grid grid-cols-2 gap-2">
					{BUILT_IN_TEMPLATES.map((template) => (
						<button
							...
							className={cn(
								"group relative rounded-lg border p-3 text-left transition-all hover:border-primary/50 hover:bg-muted/50",
