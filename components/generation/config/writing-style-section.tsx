...
import { writingStylePresets, type GenerationSettings } from "@/lib/db/schema";
...
export function WritingStyleSection({ settings, onSettingChange, tip }: WritingStyleSectionProps) {
    ...
    >
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(v) => onSettingChange("writingStylePreset", v as GenerationSettings["writingStylePreset"])}
        >
          <SelectTrigger
            id={presetId}
            aria-label="Style Preset"
        ...
        <>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => onSettingChange("customStyleDescription", e.target.value)}
              rows={4}
