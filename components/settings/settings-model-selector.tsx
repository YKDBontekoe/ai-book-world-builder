...
import { ModelList } from "../chat/multimodal-input/model-list";
import { ModelListItem } from "../chat/multimodal-input/model-list-item";
import { ModelSearchBar } from "../chat/multimodal-input/model-search-bar";
import { ModelTabs } from "../chat/multimodal-input/model-tabs";
...
function PureSettingsModelSelector({
  ...
  const {
    ...
    availableModels,
    selectedModelId: selectedModelId || availableModels[0]?.id || 'gpt-3.5-turbo', // Fallback
    onModelChange
  });
    ...
    (model: ChatModel, keyPrefix: string, showProvider = true) => {
      ...
      return (
        <ModelListItem
          ...
          isFirst={isFirst}
          isLast={isLast}
          onMoveFavorite={(id: string, dir: 'up' | 'down') => moveFavorite(id, dir)}
