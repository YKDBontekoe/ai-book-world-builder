...
export const MODEL_TABS: TabDefinition[] = [
        ...
        { id: "favorites", label: "Favorites", icon: <StarIcon className="h-3 w-3" /> },
        { id: "fast", label: "Fast", icon: <ZapIcon className="h-3 w-3" /> },
        { id: "vision", label: "Vision", icon: <EyeIcon className="h-3 w-3" /> },
        { id: "reasoning", label: "Reasoning", icon: <BrainIcon className="h-3 w-3" /> },
];
...
export const SORT_OPTION_METADATA: Record<SortOption, { label: string; icon: LucideIcon }> = {
