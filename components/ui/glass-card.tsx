...
const glassCardVariants = cva("border backdrop-blur-[40px] shadow-sm transition-all duration-300", {
	variants: {
		variant: {
            ...
            liquid: "border-glass-border bg-glass/80 hover:bg-glass hover:shadow-md hover:scale-[1.01]"
		},
		padding: {
			none: "p-0",
			sm: "p-3",
