...
import {
	...
	useSidebar,
} from "@/components/atoms/sidebar/provider";
	...
	(
		...
		if (collapsible === "none") {
			return (
				<div
					className={cn(
						"flex h-full w-[var(--sidebar-width)] flex-col glass-panel text-sidebar-foreground",
						className,
					)}
					ref={ref}
					{...props}
		...
		if (isMobile) {
			return (
				<Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
					<SheetContent
						className="w-[var(--sidebar-width)] glass-panel p-0 text-sidebar-foreground [&>button]:hidden"
						data-mobile="true"
		...
		return (
			...
			>
				...
				>
					<div
						className="flex h-full w-full flex-col glass-panel group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
						data-sidebar="sidebar"
					>
						{children}
					</div>
