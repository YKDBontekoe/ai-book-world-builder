...
export function ScenePreview({ result, projectId }: ScenePreviewProps) {
  ...
  const statusColors = {
    ...
    drafted: "text-amber-600 bg-amber-100 dark:text-amber-400 dark:bg-amber-900/30",
    completed: "text-green-600 bg-green-100 dark:text-green-400 dark:bg-green-900/30",
    revised: "text-purple-600 bg-purple-100 dark:text-purple-400 dark:bg-purple-900/30",
  };
