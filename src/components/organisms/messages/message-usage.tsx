      ...
      <Tooltip>
        ...
        <TooltipContent side="bottom" className="text-xs">
          <div className="grid gap-1 min-w-[120px]">
            <div className="font-semibold border-b pb-1 mb-1">Usage Details</div>
            <div className="grid grid-cols-[1fr_auto] gap-x-4 gap-y-1">
              <span>Input:</span>
              <span className="font-mono">{promptTokens?.toLocaleString() ?? 0}</span>
              <span>Output:</span>
              <span className="font-mono">{completionTokens?.toLocaleString() ?? 0}</span>
