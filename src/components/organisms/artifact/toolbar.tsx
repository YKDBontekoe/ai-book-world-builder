...
import { ArrowUpIcon, GraduationCapIcon, StopCircleIcon } from "lucide-react";
...
import type { ArtifactToolbarItem } from "@/components/organisms/artifact/create-artifact";
		...
		<Tooltip open={isHovered && !isAnimating}>
			<TooltipTrigger asChild>
				<motion.div
					...
					whileTap={{ scale: 0.95 }}
				>
					{selectedTool === description ? <ArrowUpIcon size={16} /> : icon}
				</motion.div>
			</TooltipTrigger>
			<TooltipContent
