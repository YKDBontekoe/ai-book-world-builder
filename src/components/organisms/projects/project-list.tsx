...
function ProjectRow({ project }: { project: Project }) {
	return (
		<div className="relative group">
			...
			<div className="absolute top-1/2 right-4 -translate-y-1/2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-200 z-10">
				<ProjectActionsMenu
