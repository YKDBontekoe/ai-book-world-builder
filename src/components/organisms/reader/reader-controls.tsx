      ...
      {isVisible && (
        <>
          ...
          >
            ...
            <h2 className="font-semibold text-sm truncate max-w-[200px]">{currentChapterTitle}</h2>
          ...
          >
            ...
            <div className="flex items-center justify-between lg:hidden mb-4">
               <Button variant="outline" onClick={onPreviousChapter} disabled={!hasPreviousChapter}>
