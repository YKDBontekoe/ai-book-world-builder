...
import { Maximize2, MessageSquare, Minimize2, X, PanelRight, PanelRightClose, GripHorizontal } from "lucide-react";
...
export function FloatingAssistant({
	...
	const [chatId, setChatId] = useLocalStorage<string>("floating-chat-session-id", generateUUID());
    ...
    const startResizeRef = useRef<{x: number, y: number, w: number, h: number} | null>(null);
					...
					>
                        ...
                        <div className="flex items-center justify-between p-3 border-b border-white/10 bg-white/5 shrink-0 select-none cursor-default group">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                >
                                    {mode === 'floating' ? <PanelRight className="h-3.5 w-3.5" /> : <PanelRightClose className="h-3.5 w-3.5" />}
                                </Button>
                                <Button
                                    variant="ghost"
                                    size="icon"
                        ...
                        {mode === 'floating' && (
                            ...
                            >
                                <div className="w-4 h-4 rounded-br bg-white/20" /> {/* Visual hint if needed, or invisible */}
