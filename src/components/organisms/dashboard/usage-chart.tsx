        ...
        <Card className="glass-card">
            ...
            <CardContent>
                    ...
                    <TabsContent value="cost" className="h-[300px]">
                        {modelData.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={modelData} margin={{ top: 20, right: 30, left: 20, bottom: 50 }}>
                                    <XAxis
                                        dataKey="name"
                                        stroke="#888888"
                                        fontSize={10}
                            ...
                            <div className="flex items-center justify-center h-full text-muted-foreground">No usage data</div>
                        )}
                    </TabsContent>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4 text-center border-t border-white/10 pt-4">
                    <div>
                        <p className="text-xs uppercase tracking-wider text-muted-foreground mb-1">Total Cost</p>
                        <p className="text-xl font-bold">${stats.totalCost.toFixed(4)}</p>
                    </div>
                     <div>
                        <p className="text-xs uppercase tracking-wider text-muted-foreground mb-1">Total Tokens</p>
                        <p className="text-xl font-bold">{(stats.totalInputTokens + stats.totalOutputTokens).toLocaleString()}</p>
                    </div>
                </div>
