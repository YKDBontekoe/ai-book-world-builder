...
export function WriterSpotlight() {
    ...
    return (
        <Dialog open={isSpotlightOpen} onOpenChange={toggleSpotlight}>
            <DialogContent className="max-w-xl p-0 gap-0 overflow-hidden bg-transparent border-none shadow-none sm:max-w-xl" hideCloseButton>
                <GlassCard variant="liquid" className="flex flex-col overflow-hidden rounded-2xl border-white/20">
                    {/* Search Input */}
