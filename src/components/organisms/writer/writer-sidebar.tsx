...
export function WriterSidebar(): JSX.Element {
    ...
    return (
        <div
            className="flex flex-col h-full border-r border-sidebar-border bg-sidebar/30 glass transition-all duration-300 ease-in-out"
        ...
        >
            ...
            <div className="px-4 py-3 border-b border-sidebar-border/50 flex items-center justify-between bg-sidebar/20 glass-panel sticky top-0 z-10">
