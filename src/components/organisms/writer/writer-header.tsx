...
import { Loader2, Save, History, PanelLeftClose, PanelLeftOpen, Maximize2, Minimize2, AlignVerticalJustifyCenter } from "lucide-react";
            ...
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button
                            variant="ghost"
                            size="icon"
                            className={cn("h-8 w-8", isTypewriterMode && "text-primary bg-primary/10")}
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        ...
                        >
                            {isZen ? <Minimize2 className="h-4 w-4" /> : <Maximize2 className="h-4 w-4" />}
                        </Button>
                    </TooltipTrigger>
                    <TooltipContent>{isZen ? "Exit Zen Mode" : "Enter Zen Mode"}</TooltipContent>
                </Tooltip>
            </TooltipProvider>
