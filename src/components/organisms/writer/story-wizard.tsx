...
import { Loader2, Sparkles, Wand2, Check, RefreshCw, Trash2, Plus } from "lucide-react";
...
import { generateBookPlan, createBookFromPlan, type BookPlan, type StoryStyle } from "@/app/actions/story-generation";
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label>Genre</Label>
                <Select value={style.genre} onValueChange={(v) => setStyle({ ...style, genre: v })}>
              ...
              <div className="space-y-2">
                <Label>POV</Label>
                <Select value={style.pov} onValueChange={(v) => setStyle({ ...style, pov: v })}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                <Label>Tone</Label>
                <Select value={style.tone} onValueChange={(v) => setStyle({ ...style, tone: v })}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    ...
                    <div className="space-y-8 max-w-3xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Chapter Outline</Label>
                            ...
                            <div className="space-y-4">
                                {plan.chapters.map((chapter, i) => (
                                    <div key={i} className="p-4 rounded-lg bg-muted/30 border border-border/50 group relative hover:border-primary/20 transition-colors">
                                        <Button
                                            variant="ghost"
                                            size="icon"
                                        ...
                                        <div className="flex items-center gap-3 mb-3 pr-8">
                                            <span className="text-xs font-mono bg-primary/10 text-primary px-2 py-1 rounded shrink-0">CH {i + 1}</span>
                                            <Input
                                                value={chapter.title}
