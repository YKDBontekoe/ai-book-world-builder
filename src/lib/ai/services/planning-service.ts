...
import { bookPlanSchema, scenePlanSchema, type StoryStyle } from "@/lib/services/schemas/story-schemas";
...
export class PlanningService {
  ...
  async planChapterScenes(chapterTitle: string, chapterSummary: string, modelId?: string) {
