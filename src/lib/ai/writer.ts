...
// Re-export deprecated functions for backward compatibility until refactor is complete
export const continueWriting = generationService.continueWriting.bind(generationService);
export const generateIdeas = generationService.generateIdeas.bind(generationService);
export const rewriteSelection = generationService.rewriteSelection.bind(generationService);
