...
export class GenerationService {
	...
	async continueWriting(
		...
		try {
			const targetModel =
				options.modelId || (await getSelectedModelId("large"));
	...
	async draftScene(
		...
		try {
			const targetModel =
				options.modelId || (await getSelectedModelId("large")); // Writer role usually uses large model
	...
	async generateIdeas(
		...
		try {
			const targetModel =
				options.modelId || (await getSelectedModelId("middle"));
