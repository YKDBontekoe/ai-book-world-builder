        ...
        <GlassCard variant="liquid" className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xl font-mono">{(Number(usage.inputTokens) / 1000).toFixed(1)}k</p>
            </div>
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground">Output Tokens</span>
              <p className="text-xl font-mono">{(Number(usage.outputTokens) / 1000).toFixed(1)}k</p>
            </div>
          </div>
        </GlassCard>
          ...
          {projects.length === 0 ? (
            ...
            <ul className="space-y-3">
              {projects.map((project) => (
                <li key={project.id} className="flex items-center justify-between p-3 rounded-md bg-muted/50">
                  <div className="space-y-1">
