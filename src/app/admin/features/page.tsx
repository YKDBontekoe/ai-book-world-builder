			...
			<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
				...
				<GlassCard variant="liquid" className="flex flex-col">
					<CardHeader>
						...
						<CardDescription>
							Interact directly with the system agent to generate new features
							or run diagnostics.
						</CardDescription>
					</CardHeader>
				...
				<GlassCard variant="liquid" className="flex flex-col">
					<CardHeader>
						...
						<CardDescription>
							Sync repository data, manage pull requests, and trigger CI/CD
							pipelines.
						</CardDescription>
					</CardHeader>
					<CardContent className="mt-auto pt-4">
				...
				<GlassCard variant="liquid" className="flex flex-col">
					<CardHeader>
						...
						<CardDescription>
							Toggle global features, manage maintenance mode, and configure API
							limits.
						</CardDescription>
					</CardHeader>
					<CardContent className="mt-auto pt-4">
