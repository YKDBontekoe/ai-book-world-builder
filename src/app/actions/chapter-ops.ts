...
export const reorderChaptersAction = async (
	...
	return withProjectWriteAccess(input.projectId, async () => {
		...
		try {
			...
			throw new ChatSDKError("bad_request" as any, "Failed to reorder chapters");
		}
	});
};
...
export const updateChapterAction = async (
	...
	return withProjectWriteAccess(input.projectId, async () => {
		try {
			...
			throw new ChatSDKError("bad_request" as any, "Failed to update chapter");
		}
	});
};
	...
	return withProjectWriteAccess(input.projectId, async () => {
		try {
			...
			if (outlines.length === 0) {
				throw new ChatSDKError("not_found" as any, "Project outline not found");
			}
			...
			throw new ChatSDKError("bad_request" as any, "Failed to create chapter");
		}
	});
};
...
export const deleteChapterAction = async (
	...
	return withProjectWriteAccess(input.projectId, async () => {
		try {
			...
			throw new ChatSDKError("bad_request" as any, "Failed to delete chapter");
		}
	});
};
