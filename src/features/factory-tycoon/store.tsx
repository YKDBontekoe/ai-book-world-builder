...
function gameReducer(state: GameState, action: Action): GameState {
	switch (action.type) {
		...
		case "ADD_BUILDING": {
			...
			// Performance: Keep buildings sorted by ID to avoid sorting every tick
			const newBuildings = [...state.buildings, newBuilding].sort((a, b) =>
		...
		case "SET_STATE":
			// Ensure loaded state is sorted
			return {
				...action.payload,
				buildings: [...action.payload.buildings].sort((a, b) =>
					a.id.localeCompare(b.id),
				),
			};
