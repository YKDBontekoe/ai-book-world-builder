      ...
      >
        ...
        <div className="mx-5 mt-5 led-display flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-[var(--factory-text-secondary)]">Available Science</span>
          </div>
          <span className="led-value text-purple-400 text-2xl">{state.science}</span>
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    {tech.unlocks && tech.unlocks.length > 0 && (
                      <div className="mt-3 flex items-center gap-2">
                        <span className="text-[10px] uppercase text-[var(--factory-text-muted)] font-bold">Unlocks:</span>
                  ...
                  {!isResearched && (
                    <div className="text-right shrink-0">
                      <div className={cn(
                        ...
                        canAfford ? "text-purple-400" : "text-[var(--factory-danger)]"
                      )}>
                        {tech.cost}
                      </div>
                      <div className="text-[10px] text-[var(--factory-text-muted)] uppercase">Science</div>
                    </div>
                  )}
                </div>
