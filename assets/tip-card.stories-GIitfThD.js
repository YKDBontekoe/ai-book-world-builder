import{j as r}from"./jsx-runtime-CHDYqJOC.js";import{c as m}from"./index-B_jtOnfb.js";import{r as f}from"./iframe-BLXEDfaJ.js";import{c}from"./utils-CDN07tui.js";import{c as g}from"./createLucideIcon-BaYlDcfR.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CE1G-McA.js";const h=[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]],b=g("lightbulb",h),x=m("flex items-start gap-3 rounded-xl border p-3 backdrop-blur-sm",{variants:{variant:{info:"border-blue-500/20 bg-blue-500/5",warning:"border-amber-500/20 bg-amber-500/5",success:"border-emerald-500/20 bg-emerald-500/5",error:"border-red-500/20 bg-red-500/5"}},defaultVariants:{variant:"info"}}),y={info:"text-blue-500",warning:"text-amber-500",success:"text-emerald-500",error:"text-red-500"},v={info:"text-blue-700 dark:text-blue-300",warning:"text-amber-700 dark:text-amber-300",success:"text-emerald-700 dark:text-emerald-300",error:"text-red-700 dark:text-red-300"},o=f.forwardRef(({className:e,variant:i="info",icon:d=b,children:l,...p},u)=>r.jsxs("div",{ref:u,className:c(x({variant:i}),e),...p,children:[r.jsx(d,{className:c("mt-0.5 h-4 w-4 shrink-0",y[i||"info"]),"aria-hidden":"true"}),r.jsx("div",{className:c("text-sm",v[i||"info"]),children:l})]}));o.displayName="TipCard";try{o.displayName="TipCard",o.__docgenInfo={description:`A tip/info card component for displaying helpful hints and callouts.
