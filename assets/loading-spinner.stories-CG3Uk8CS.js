import{j as r}from"./jsx-runtime-0OksyS6h.js";import{c as m}from"./index-B_jtOnfb.js";import{r as p}from"./iframe-KnHGdWlU.js";import{c as u}from"./utils-CDN07tui.js";import{L as l}from"./loader-circle-B1mClU_f.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CE1G-McA.js";import"./createLucideIcon-BgmyJ04y.js";const g=m("animate-spin",{variants:{size:{xs:"h-3 w-3",sm:"h-4 w-4",md:"h-6 w-6",lg:"h-8 w-8"},variant:{default:"text-foreground",primary:"text-primary",muted:"text-muted-foreground",success:"text-[var(--status-success)]",warning:"text-[var(--status-warning)]",error:"text-[var(--status-error)]",info:"text-[var(--status-info)]"}},defaultVariants:{size:"sm",variant:"muted"}}),e=p.forwardRef(({className:i,size:t,variant:o,...d},c)=>r.jsx(l,{ref:c,className:u(g({size:t,variant:o}),i),...d}));e.displayName="LoadingSpinner";try{e.displayName="LoadingSpinner",e.__docgenInfo={description:`A unified loading spinner component with consistent sizing and color variants.
Replaces scattered Loader2 instances throughout the codebase.`,displayName:"LoadingSpinner",props:{variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:'"success" | "error" | "warning" | "info" | "default" | "primary" | "muted" | null'}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:'"sm" | "lg" | "md" | "xs" | null'}}}}}catch{}const h={title:"Design System/Atoms/LoadingSpinner",component:e,tags:["autodocs"],parameters:{layout:"centered"}},a={args:{size:"md",variant:"default"}},n={render:()=>r.jsxs("div",{className:"flex gap-4 items-center",children:[r.jsx(e,{size:"xs"}),r.jsx(e,{size:"sm"}),r.jsx(e,{size:"md"}),r.jsx(e,{size:"lg"})]})},s={render:()=>r.jsxs("div",{className:"flex gap-4 items-center bg-zinc-100 p-4 rounded",children:[r.jsx(e,{variant:"primary"}),r.jsx(e,{variant:"muted"}),r.jsx(e,{variant:"success"}),r.jsx(e,{variant:"warning"}),r.jsx(e,{variant:"error"})]})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    size: "md",
    variant: "default"
  }
