import{j as r}from"./jsx-runtime-DOx_0nUc.js";import{C as d,d as m}from"./card-D5iWaT9K.js";import{c}from"./utils-CDN07tui.js";import"./iframe-DeEpvSF-.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CE1G-McA.js";import"./index-B_jtOnfb.js";function n({children:s,className:t,columns:e={mobile:1,sm:2,lg:3},gap:o=4,...l}){return r.jsx("div",{className:c("grid","grid-cols-1",e.sm&&`sm:grid-cols-${e.sm}`,e.md&&`md:grid-cols-${e.md}`,e.lg&&`lg:grid-cols-${e.lg}`,e.xl&&`xl:grid-cols-${e.xl}`,`gap-${o}`,t),...l,children:s})}try{n.displayName="GridList",n.__docgenInfo={description:"",displayName:"GridList",props:{columns:{defaultValue:{value:"{ mobile: 1, sm: 2, lg: 3 }"},description:"",name:"columns",required:!1,type:{name:"{ mobile?: number; sm?: number; md?: number | undefined; lg?: number | undefined; xl?: number | undefined; } | undefined"}},gap:{defaultValue:{value:"4"},description:"",name:"gap",required:!1,type:{name:"number"}}}}}catch{}const b={title:"Design System/Atoms/GridList",component:n,tags:["autodocs"],parameters:{layout:"padded"}},a={render:s=>r.jsx(n,{...s,children:Array.from({length:6}).map((t,e)=>r.jsx(d,{children:r.jsxs(m,{className:"p-6",children:[r.jsxs("div",{className:"font-medium",children:["Item ",e+1]}),r.jsxs("div",{className:"text-sm text-muted-foreground",children:["Description for item ",e+1]})]})},e))})},i={args:{columns:{mobile:1,sm:2,lg:3,xl:4},gap:6},render:s=>r.jsx(n,{...s,children:Array.from({length:8}).map((t,e)=>r.jsx(d,{children:r.jsx(m,{className:"p-6",children:r.jsxs("div",{className:"font-medium",children:["Item ",e+1]})})},e))})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
