import { BookOpen, Globe, Palette, Sparkles, Users, Zap, PlayCircle, ArrowRight, LayoutTemplate } from "lucide-react";
		...
		<div className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-br from-violet-50/50 via-white to-indigo-50/50 dark:from-zinc-950 dark:via-zinc-900 dark:to-violet-950/30">
			...
			<header className="relative z-10 border-white/20 border-b bg-white/40 backdrop-blur-xl dark:border-zinc-800/30 dark:bg-zinc-900/30">
				<div className="container mx-auto flex items-center justify-between px-6 py-4">
					...
					<div className="flex items-center gap-3">
						...
						<Link href="/register">
							<Button className="bg-violet-600 hover:bg-violet-700 shadow-lg shadow-violet-500/20 transition-all hover:scale-105" size="sm">
								Get Started
							</Button>
						</Link>
					</div>
			...
			<main className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-20 lg:py-32">
				<div className="mx-auto max-w-5xl text-center">
					<div className="mb-8 inline-flex animate-in fade-in slide-in-from-bottom-4 duration-700 items-center gap-2 rounded-full border border-violet-200/50 bg-white/50 px-4 py-1.5 text-sm font-medium text-violet-700 shadow-sm backdrop-blur-md dark:border-violet-800/50 dark:bg-violet-950/30 dark:text-violet-300">
						<Sparkles className="h-3.5 w-3.5 fill-violet-500 text-violet-500" />
						<span>AI-Powered World Building Suite</span>
					</div>

					<h2 className="mb-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100 bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600 bg-clip-text pb-2 font-bold text-6xl text-transparent leading-[1.1] tracking-tight md:text-7xl lg:text-8xl dark:from-violet-400 dark:via-indigo-400 dark:to-blue-400">
						Build Your Story Universe
					</h2>

					<p className="mx-auto mb-12 max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 text-lg text-zinc-600 md:text-xl leading-relaxed dark:text-zinc-300">
						Create rich, interconnected worlds for your books with intelligent AI assistance.
						Manage characters, locations, timelines, and lore in one cohesive workspace.
					</p>

					<div className="mb-24 flex animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300 flex-wrap items-center justify-center gap-4">
						<Link href="/register">
							<Button
                    ...
                    <div className="mb-24 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
                        <h3 className="mb-12 font-semibold text-2xl text-zinc-900 text-center dark:text-white">Your creative workflow, reimagined</h3>
                        <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
                            <GlassCard variant="liquid" className="flex flex-col items-center text-center p-8 relative overflow-hidden">
                                ...
                                <h4 className="mb-2 font-semibold text-lg">1. Define Your World</h4>
                                <p className="text-zinc-500 dark:text-zinc-400">Set the stage with locations, cultures, and lore that form the foundation.</p>
                            </GlassCard>
                            <GlassCard variant="liquid" className="flex flex-col items-center text-center p-8 relative overflow-hidden">
                                ...
                                <h4 className="mb-2 font-semibold text-lg">2. Populate Characters</h4>
                                <p className="text-zinc-500 dark:text-zinc-400">Create deep, interconnected characters with AI-assisted backstories.</p>
                            </GlassCard>
                            <GlassCard variant="liquid" className="flex flex-col items-center text-center p-8 relative overflow-hidden">
                                ...
                                <h4 className="mb-2 font-semibold text-lg">3. Generate Story</h4>
                                <p className="text-zinc-500 dark:text-zinc-400">Weave your elements together into outlines, chapters, and full scenes.</p>
                            </GlassCard>
                        </div>
                    </div>

					{/* Feature Grid */}
					<div id="features" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
						<FeatureCard
				...
				<div className="container mx-auto px-6 py-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-zinc-900 dark:text-white">AI Book World Builder</span>
                        </div>
					    <p className="text-sm text-zinc-500 dark:text-zinc-400">© 2024 AI Book World Builder. All rights reserved.</p>
                    </div>
				</div>
			</footer>
		</div>
...
function FeatureCard({
	...
	return (
		<GlassCard variant="liquid" className="group relative overflow-hidden p-6 hover:-translate-y-1 transition-transform duration-300">
			<div
				className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-0 transition-opacity duration-500 group-hover:opacity-[0.03]`}
			/>
            <div className={`absolute -right-12 -top-12 h-40 w-40 rounded-full bg-gradient-to-br ${gradient} blur-3xl opacity-0 transition-opacity duration-500 group-hover:opacity-20`} />
